...
INeph1 = '/home/austen/PycharmProjects/Integrating Nephelometer/Data/Neph Data/06-19-2017/NL170619Frame.csv'
...
#SAE(INEPH)
NephDat = SAE(INEPH)
path = '/home/austen/PycharmProjects/Integrating Nephelometer/Data/Neph Data/06-19-2017/CorrectedData.csv'
...
axx.xaxis.set_major_formatter(xfmt)
axx.plot(time_axis, NephDat['Corrected Blue Data'], 'b-', label='Corrected Blue Coefficients')
axx.plot(time_axis, NephDat['Corrected Green Data'], 'g-', label='Corrected Green Coefficients')
axx.plot(time_axis, NephDat['Corrected Red Data'], 'r-', label='Corrected Red Coefficients')
axx.legend(loc=1)
axx.set_title('Blue, Green, and Red Corrected Scattering Coefficients as a Function of Time')
axx.set_xlabel('Time (H:M:S)')
axx.set_ylabel('Corrected b')
